...
const container_img = document.getElementById('box-img');
const container_temp = document.querySelector('.box-temp');
const temp_number = document.querySelector('.box-temp div');
const temp_unit = document.querySelector('.box-temp span');
const weather_t = document.getElementById('descricao');
const search_input = document.querySelector('.form-control');
const search_button = document.querySelector('.btn');
const low_high = document.getElementById('max-min');
